...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "SELECT uid FROM login where username = '" .  $loginEmail . "' and password = '" . $loginPassword . "'";
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-10 ftco-animate">
          <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" <h3 class="mb-4 billing-heading">Login Here!</h3>
